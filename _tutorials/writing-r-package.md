...
__This tutorial was originally created by the University of Stirling's Coding Club, [Github](https://stirlingcodingclub.github.io/SCC_R_package/notebook/Rpackage_notes.html" target="_blank">and can be found at this link</a>. Our Coding Club would like to extend our deepest gratitude to them, for allowing us to publish this tutorial on our website as well. After going through this tutorial, you will be able to write a basic R package, which can be installed from <a href="http://github.com).__
...
Before getting started, we need to install the [roxygen2](https://cran.r-project.org/package=devtools" target="_blank">devtools</a> and <a href="https://cran.r-project.org/package=roxygen2) packages. The former contains a large bundle of tools needed in package development, while the latter is used to easily write documentation.
...
![]({{ site.baseurl }}/img/rpackage1.png" alt="Img" style="width: 1000px;)
...
![]({{ site.baseurl }}/img/rpackage2.png" alt="Img" style="width: 1000px;)
...
![]({{ site.baseurl }}/img/rpackage3.png" alt="Img" style="width: 1000px;)
...
![]({{ site.baseurl }}/img/rpackage4.png" alt="Img" style="width: 1000px;)
...
![]({{ site.baseurl }}/img/rpackage5.png" alt="Img" style="width: 1000px;)
...
![]({{ site.baseurl }}/img/rpackage6.png" alt="Img" style="width: 1000px;)
...
![]({{ site.baseurl }}/img/rpackage7.png" alt="Img" style="width: 1000px;)
...
![]({{ site.baseurl }}/img/rpackage8.png" alt="Img" style="width: 1000px;)
...
![]({{ site.baseurl }}/img/rpackage9.png" alt="Img" style="width: 1000px;)
...
![]({{ site.baseurl }}/img/rpackage10.png" alt="Img" style="width: 1000px;)
...
![]({{ site.baseurl }}/img/rpackage11.png" alt="Img" style="width: 1000px;)
...
![]({{ site.baseurl }}/img/rpackage12.png" alt="Img" style="width: 1000px;)
...
![]({{ site.baseurl }}/img/rpackage13.png" alt="Img" style="width: 1000px;)
...
![]({{ site.baseurl }}/img/rpackage14.png" alt="Img" style="width: 1000px;)
...
![]({{ site.baseurl }}/img/rpackage15.png" alt="Img" style="width: 1000px;)
...
- **docs** includes documents for the [pkgdown](https://confoobio.github.io/gmse/" target="_blank">GMSE website</a>, which was produced in less than 20 minutes using the extremely helpful <a href="https://pkgdown.r-lib.org/) R package (I highly recommend this for building website for your R package).
...
![]({{ site.baseurl }}/img/rpackage16.png" alt="Img" style="width: 1000px;)

**Tagging a version**

It is sometimes helpful to 'tag' a particular commit in git to identify a particular version or 'release' of your R package (e.g., [version control](https://github.com/ConFooBio/gmse/releases" target="_blank">in GMSE</a>). I did not go into detail about using git tags in the <a href="https://stirlingcodingclub.github.io/version_control/vc_notes.html) session, but the general idea is that a tag is essentially a commit that has a meaningful name rather than a large number -- the tag is therefore a snapshot of a particular point in the history of the repository that is of particular interest. In the command line, a commit works as below.
...
![]({{ site.baseurl }}/img/rpackage17.png" alt="Img" style="width: 1000px;)
...
![]({{ site.baseurl }}/img/rpackage18.png" alt="Img" style="width: 1000px;)
...
![]({{ site.baseurl }}/img/rpackage19.png" alt="Img" style="width: 1000px;)
